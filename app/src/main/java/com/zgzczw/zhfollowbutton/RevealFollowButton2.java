...
public class RevealFollowButton2 extends FrameLayout {
    ...
    public RevealFollowButton2(Context paramContext) {
        super(paramContext);
        init();
    }

    public RevealFollowButton2(Context paramContext, AttributeSet paramAttributeSet) {
        super(paramContext, paramAttributeSet);
        init();
    }

    public RevealFollowButton2(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                mPath1.addCircle(0, 0, radius, Path.Direction.CW);
